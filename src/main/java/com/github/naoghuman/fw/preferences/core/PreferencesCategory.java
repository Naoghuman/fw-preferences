 ...
 * @author Naoghuman
 */
public final class PreferencesCategory implements PreferencesJson {
    ...
    // START  CATEGORIES -------------------------------------------------------
    private List<PreferencesCategory> _categories = FXCollections.observableArrayList();

    public List<PreferencesCategory> getCategories() {
        return _categories;
    }

    public final void setCategories(final List<PreferencesCategory> categories) {
        _categories.clear();
    ...
    public String toString() {
        ...
        sb.append("PreferencesCategory [").append("\n");
